...
test("Testing equals", () => {
  ...
  expect(equals({test: {test2: "test2"}})({test: {test2: "test2"}})).toBe(true);
  expect(equals({test: {test2: "test"}})({test: {test2: "test2"}})).toBe(false);
  expect(equals({test: {test: "test2"}})({test: {test2: "test2"}})).toBe(false);
});
