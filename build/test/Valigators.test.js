...
test("Testing default validators", function () {
    ...
    expect(validate.validate({ name: [1, 2, 3] }, {
        name: {
            type: "array",
        },
    })).toBe(true);
    ...
    expect(validate.validate({ name: true }, {
        name: {
            type: "boolean",
        },
    })).toBe(true);
    ...
    expect(validate.validate({ name: "test@test.com" }, {
        name: {
            type: "email",
        },
    })).toBe(true);
...
test("Testing required", function () {
    var validate = new Valigators_1.Valigator();
    expect(validate.validate({ name: "" }, {
        name: {
            type: "text",
        },
    })).toBe(false);
    expect(validate.validate({ person: { name: { lastName: "sfs" } } }, { person: { name: { lastName: { type: "text" } } } })).toBe(true);
});
test("Testing validate_more", function () {
    var validate = new Valigators_1.Valigator();
    // Shape matches data
    expect(validate.validate_more({ name: "sdf", nested: { inner: "hi" } }, {
        name: {
            type: "text",
        },
        nested: {
    ...
    expect(validate.validate_more({ nested: { inner: "hi" } }, {
    ...
    expect(validate.validate_more({ foo: "dsf", bar: "dsf" }, {
        foo: {
            type: "text",
        },
        bar: {
    ...
    expect(validate.validate_more({ foo: "dsf" }, {
        foo: {
            type: "text",
            validators: [Valigators_1.minLength(2)],
        },
    })).toEqual({
        success: true,
        values: {
    ...
    expect(validate.validate_more({ foo: "dsf" }, {
        foo: {
            type: "text",
            validators: [Valigators_1.minLength(5)],
        },
    })).toEqual({
        success: false,
        values: {
